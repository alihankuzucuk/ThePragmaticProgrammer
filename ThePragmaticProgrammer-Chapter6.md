...
* Document your assumptions. [Design by Contract](./ThePragmaticProgrammer-Chapter4.md#21---design-by-contract).
* Don't just test your code, but test your assumptions as well. Don't guess [Assertive Programming](./ThePragmaticProgrammer-Chapter4.md#23---assertive-programming)
* Prioritize your effort.
* Don't be a slave to history. Don't let existing code dictate future code. [Refactoring](./ThePragmaticProgrammer-Chapter6.md#33---refactoring)
...
* Duplication. You've discovered a violation of the DRY principle ([The Evils of Duplication](./ThePragmaticProgrammer-Chapter2.md#7---the-evils-of-duplication)).
* Nonorthogonal design. You've discovered some code or design that could be made more orthogonal ([Orthogonality](./ThePragmaticProgrammer-Chapter2.md#8---orthogonality)).
